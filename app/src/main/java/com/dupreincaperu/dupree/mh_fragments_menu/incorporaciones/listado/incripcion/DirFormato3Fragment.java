...
import com.dupreincaperu.dupree.databinding.FragmentDireccionFormato3Binding;
 ...
 */
public class DirFormato3Fragment extends BaseFragment implements View.OnClickListener {

    public static String TAG = DirFormato3Fragment.class.getName();
    private FragmentDireccionFormato3Binding binding;
    ...
    public DirFormato3Fragment() {
        // Required empty public constructor
    }

    @Override
    protected int getMainLayout() {
        return R.layout.fragment_direccion_formato3;
    }
    ...
    protected void initViews(ViewDataBinding view) {
        binding = (FragmentDireccionFormato3Binding) view;
