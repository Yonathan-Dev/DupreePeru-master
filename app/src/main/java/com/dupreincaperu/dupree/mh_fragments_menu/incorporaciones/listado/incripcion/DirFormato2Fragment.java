...
import com.dupreincaperu.dupree.databinding.FragmentDireccionFormato2Binding;
 ...
 */
public class DirFormato2Fragment extends BaseFragment implements View.OnClickListener {

    public static String TAG = DirFormato2Fragment.class.getName();
    private FragmentDireccionFormato2Binding binding;
    ...
    public DirFormato2Fragment() {
        // Required empty public constructor
    }

    @Override
    protected int getMainLayout() {
        return R.layout.fragment_direccion_formato2;
    }
    ...
    protected void initViews(ViewDataBinding view) {
        binding = (FragmentDireccionFormato2Binding) view;
    ...
    public void onClick(View view) {
        switch (view.getId()){
           ...
           /* case R.id.txt_spn_bis1://
                ...
                break;
            case R.id.txt_spn_bis2://
                showList(view.getId(), getString(R.string.bis), listBis, model.getBis2());
                break;*/
    ...
    public boolean validateDirResidencia(){
        ...
        if (!model.getTipo_via1().toUpperCase().equals("Otro".toUpperCase()))
        {
           /* if(model.getNumero1().isEmpty()){
            ...
            if(model.getNumero4().isEmpty()){
                msgToast("Dir. Res. > Número 4... Verifique");
                valid.setLoginError(getResources().getString(R.string.campo_requerido), binding.txtNumero4);
                return false;
            }*/
        }
        ...
        if (model.isShowDirEnvio()) {
            ...
            if (!model.getTipo_via_env_1().toUpperCase().equals("Otro".toUpperCase())) {
                ...
                if (model.getNumero_env_3().isEmpty()) {
                    msgToast("Dir. Envío > Número 3... Verifique");
                    valid.setLoginError(getResources().getString(R.string.campo_requerido), binding.txtNumeroEnv3);
                    return false;
                }
                if (model.getNumero_env_4().isEmpty()) {
                    msgToast("Dir. Envío > Número 4... Verifique");
                    valid.setLoginError(getResources().getString(R.string.campo_requerido), binding.txtNumeroEnv4);
                    return false;
                }
            }
                ...
                switch(id){
                   ...
                   /* case R.id.txt_spn_bis1:
                    ...
                    case R.id.txt_spn_bis2:
                        ...
                        model.setBis2(item.getId() == -1 ? "" : item.getName());
                        break;*/
                }
            }
        });
